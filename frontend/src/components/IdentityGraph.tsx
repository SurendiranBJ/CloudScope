...
export const IdentityGraph: React.FC<IdentityGraphProps> = ({
  ...
  return (
    <div className="w-full h-full relative bg-[#0B1120] overflow-hidden">
      ...
      {/* Legend Overlay */}
      <div className="absolute bottom-6 left-6 z-10 bg-[#0F172A]/90 backdrop-blur-md border border-gray-800 rounded-lg p-4 w-48 shadow-2xl">
        <h4 className="text-xs font-semibold text-gray-300 mb-3 border-b border-gray-800 pb-2">Legend</h4>
